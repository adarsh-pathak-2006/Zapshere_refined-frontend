  ...
  return (
    <>
      ...
      <section className="services-section pt-0 pb-100">
        <div className="auto-container">
          <div className="sec-title text-center">
            <span className="sub-title"><Image loading="lazy" decoding="async" src="/images/sub-title-shape.svg" alt="" width={800} height={800} style={{ width: "100%", height: "auto" }} />Why It Matters</span>
      ...
      <section className="process-section section-padding fix" style={{ background: 'rgba(255,255,255,0.01)' }}>
        <div className="auto-container">
          <div className="sec-title text-center">
            <span className="sub-title"><Image loading="lazy" decoding="async" src="/images/sub-title-shape.svg" alt="" width={800} height={800} style={{ width: "100%", height: "auto" }} />How We Do It</span>
      ...
      <section className="services-section-two pt-100 pb-100">
        <div className="auto-container">
          <div className="sec-title text-center">
            <span className="sub-title"><Image loading="lazy" decoding="async" src="/images/sub-title-shape.svg" alt="" width={800} height={800} style={{ width: "100%", height: "auto" }} />What You Get</span>
          ...
          <div className="row align-items-center">
            <div className="col-lg-6 mb-5 mb-lg-0 wow fadeInLeft">
              <div className="sec-title">
                <span className="sub-title"><Image loading="lazy" decoding="async" src="/images/sub-title-shape.svg" alt="" width={800} height={800} style={{ width: "100%", height: "auto" }} />Expected Outcomes</span>
      ...
      <section className="works-section section-padding pt-100 pb-100">
        <div className="auto-container">
          <div className="sec-title text-center">
            <span className="sub-title"><Image loading="lazy" decoding="async" src="/images/sub-title-shape.svg" alt="" width={800} height={800} style={{ width: "100%", height: "auto" }} />Proven Success</span>
          ...
          <div className="row mt-5">
            <div className="col-lg-4 col-md-6 mb-4 wow fadeInUp">
              <div className="work-single-box premium-hover-card" style={{ background: 'rgba(255,255,255,0.03)', borderRadius: '15px', overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column' }}>
                <Image loading="lazy" decoding="async" src="/images/case-study-saas.png" alt="B2B SaaS" width={800} height={800} style={{ width: '100%', height: '250px', objectFit: 'cover' }} />
            ...
            <div className="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-wow-delay=".2s">
              <div className="work-single-box premium-hover-card" style={{ background: 'rgba(255,255,255,0.03)', borderRadius: '15px', overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column' }}>
                <Image loading="lazy" decoding="async" src="/images/case-study-ecommerce.png" alt="eCommerce" width={800} height={800} style={{ width: '100%', height: '250px', objectFit: 'cover' }} />
                <div style={{ padding: '30px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
            ...
            <div className="col-lg-4 col-md-6 mb-4 wow fadeInUp" data-wow-delay=".4s">
              <div className="work-single-box premium-hover-card" style={{ background: 'rgba(255,255,255,0.03)', borderRadius: '15px', overflow: 'hidden', height: '100%', display: 'flex', flexDirection: 'column' }}>
                <Image loading="lazy" decoding="async" src="/images/case-study-enterprise.png" alt="Enterprise" width={800} height={800} style={{ width: '100%', height: '250px', objectFit: 'cover' }} />
                <div style={{ padding: '30px', display: 'flex', flexDirection: 'column', flexGrow: 1 }}>
            ...
            <div className="col-lg-6 col-md-12 col-sm-12 wow fadeInLeft">
              <div className="contact-right-warp">
                <div className="sec-title style_color">
                  <span className="sub-title"><Image loading="lazy" decoding="async" src="/images/sub-titls.svg" alt="" width={800} height={800} style={{ width: "100%", height: "auto" }} />Next Steps</span>
